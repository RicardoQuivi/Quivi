            ...
            <div className="relative flex items-center justify-center z-1 mt-10 mb-10">
                <div className="flex flex-col items-center max-w-xs">
                    ...
                    >
                        ...
                        <path d="M108.239 15H24.9463C22.6356 15 20.7623 16.8807 20.7623 19.2006V66.7833C20.7623 69.1032 22.6356 70.9839 24.9463 70.9839H108.239C110.55 70.9839 112.423 69.1032 112.423 66.7833V19.2006C112.423 16.8807 110.55 15 108.239 15Z" fill="#FF3F01" stroke="#263238" strokeWidth="1.29468" strokeLinecap="round" strokeLinejoin="round"/>
                        ...
                        <path d="M118.218 13.0928L106.502 24.8545L101.177 19.5083" stroke="#FF3F01" strokeWidth="2.94184" strokeLinecap="round" strokeLinejoin="round"/>
                    </svg>
                </div>
            </div>
            <p className="text-sm text-gray-500 dark:text-gray-400">
