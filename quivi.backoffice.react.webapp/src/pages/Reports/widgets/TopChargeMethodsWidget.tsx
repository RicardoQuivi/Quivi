...
import { ChargeMethodSales } from "../../../hooks/api/Dtos/reporting/ChargeMethodSales";
...
export const TopChargeMethodsWidget = (props: Props) => {
    ...
    const widgetProps = useMemo(() => {
        if(props.by == ProductSalesSortBy.SoldQuantity) {
            return {
                ...
                valueLabel: t("widgets.topChargeMethods.quantityLabel"),
                getValue: (d: ChargeMethodSales) => d.totalInvoices.toFixed(0),
            }
        }
