...
{
    public class OnPosChargeOperationEventHandler : BackgroundEventHandler<OnPosChargeOperationEvent>
    {
        private readonly IQueryProcessor queryProcessor;
        private readonly ICommandProcessor commandProcessor;
        private readonly IPosSyncService posSyncService;

        public OnPosChargeOperationEventHandler(IQueryProcessor queryProcessor,
