...
namespace Quivi.Domain.Repositories.EntityFramework.Migrations
{
    ...
    [Migration("20250629110405_PrinterMessageTargets")]
    partial class PrinterMessageTargets
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Quivi.Domain.Entities.Charges.CardCharge", b =>
                {
            ...
            modelBuilder.Entity("Quivi.Domain.Entities.Charges.MbWayCharge", b =>
                {
                    b.Property<int>("ChargeId")
                        .HasColumnType("int");
                    ...
                    b.ToTable("MbWayCharges");
                });

            modelBuilder.Entity("Quivi.Domain.Entities.Charges.TerminalCharge", b =>
                {
                    b.Property<int>("ChargeId")
                        .HasColumnType("int");
                    ...
                    b.ToTable("TerminalCharge");
                });

            modelBuilder.Entity("Quivi.Domain.Entities.Charges.TicketMobileCharge", b =>
                {
                    b.Property<int>("ChargeId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Quivi.Domain.Entities.Financing.JournalChange", b =>
                {
                    b.Property<int>("JournalHistoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("JournalHistoryId"));
            ...
            modelBuilder.Entity("Quivi.Domain.Entities.Charges.CardCharge", b =>
                {
                    b.HasOne("Quivi.Domain.Entities.Charges.Charge", "Charge")
                        .WithOne("CardCharge")
                        .HasForeignKey("Quivi.Domain.Entities.Charges.CardCharge", "ChargeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Quivi.Domain.Entities.Charges.MbWayCharge", b =>
                {
                    b.HasOne("Quivi.Domain.Entities.Charges.Charge", "Charge")
                        .WithOne("MbWayCharge")
                        .HasForeignKey("Quivi.Domain.Entities.Charges.MbWayCharge", "ChargeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Quivi.Domain.Entities.Charges.TerminalCharge", b =>
                {
                    b.HasOne("Quivi.Domain.Entities.Charges.Charge", "Charge")
                        .WithOne("TerminalCharge")
                        .HasForeignKey("Quivi.Domain.Entities.Charges.TerminalCharge", "ChargeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Quivi.Domain.Entities.Charges.TicketMobileCharge", b =>
                {
                    b.HasOne("Quivi.Domain.Entities.Charges.Charge", "Charge")
                        .WithOne("TicketMobileCharge")
                        .HasForeignKey("Quivi.Domain.Entities.Charges.TicketMobileCharge", "ChargeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Quivi.Domain.Entities.Charges.Charge", b =>
                {
                    b.Navigation("CardCharge");

                    b.Navigation("Deposit");

                    b.Navigation("InvoiceDocuments");

                    b.Navigation("MbWayCharge");

                    b.Navigation("MerchantCustomCharge");

                    b.Navigation("PosCharge");

                    b.Navigation("TerminalCharge");

                    b.Navigation("TicketMobileCharge");
                });
