...
export class BackgroundJobPromise implements Promise<void>, BackgroundJobEventListener {
    ...
    constructor (jobId: string, private client: IWebClient, private getJobStatus: (jobId: string) => Promise<JobState>) {
        ...
        client.addBackgroundJobListener(this);
    ...
    dispose(success: boolean) {
        ...
        this.client.removeBackgroundJobListener(this);
    ...
    private polling() {
        this.timerCalls++;        
        this.onBackgroundJobChangedEvent()
